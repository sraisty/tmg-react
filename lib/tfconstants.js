 ...
 *
 */
export const VALID_VERT_JUMPS = ['PV', 'HJ'];
export const VALID_HORZ_JUMPS = ['LJ', 'TJ'];
export const VALID_THROWS = ['DT', 'SP'];

export const VALID_FIELD_EVENTS =
    VALID_THROWS.concat(VALID_HORZ_JUMPS, VALID_VERT_JUMPS);

export const VALID_INDIV_TRACK_EVENTS = ['100', '200', '400', '800', '1500',
    '1600', '3000', '3200', '100H', '110H', '300H'];

export const VALID_INDIV_EVENTS =
    VALID_INDIV_TRACK_EVENTS.concat(VALID_FIELD_EVENTS);
 ...
 **/
export const VALID_RELAYS = ['4x100', '4x400'];
export const ValidHyTekRelays = ['400', '1600'];

export const VALID_TRACK_EVENTS =
    VALID_INDIV_TRACK_EVENTS.concat(VALID_RELAYS);


export const VALID_COMBINED_EVENTS = [];

export const VALID_EVENTS =
    VALID_INDIV_EVENTS.concat(VALID_RELAYS, VALID_COMBINED_EVENTS);
