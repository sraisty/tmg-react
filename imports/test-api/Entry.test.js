...
describe('Entry - is it Field/Track/Relay Event tests?', function () {
  describe('trackEvent()', function () {
    const e = new Entry({firstName: 'Tyrion', lastName: 'Lannister', gender: 'M', eventCode: '100'});
    it('100', function () {
  ...
  describe('fieldEvent()', function () {
    const e = new Entry({firstName: 'Tyrion', lastName: 'Lannister', gender: 'M', eventCode: 'HJ'});
    it('HJ', function () {
...
describe('convertMarkToNumber', function () {
  describe('Track - timed events', function () {
    const e = new Entry({firstName: 'Tyrion', lastName: 'Lannister', gender: 'M', eventCode: '1600'});
    for (let i = 0; i < TestTimes.length; i++) {
      const tt = TestTimes[i];
  ...
  describe('Field Events - imperial measures', function () {
    // TODO
    const e = new Entry({firstName: 'Cersei', lastName: 'Lannister', gender: 'F', eventCode: 'DT'});
